...
BEGIN
  ...
  FOR rec IN SELECT * FROM (VALUES
    ...
    (2,  'Kaypian',       'Sitio Bayan',    14.8145, 121.0460, 'low_pressure',     'primewater',    'approved',           true,  false, NULL,                                                                   'Mahina pressure ng tubig.', NOW() - INTERVAL '2 days'),
    ...
    (4,  'Muzon',         'St. Joseph St.', 14.8210, 121.0370, 'water_leak',       'metro_pacific', 'approved',           true,  false, NULL,                                                                   'Tumutulo ang tubo sa kalsada.', NOW() - INTERVAL '4 days'),
    ...
    (8,  'Poblacion',     'Blk 3',          14.8230, 121.0360, 'no_water',         'primewater',    'approved',           true,  false, NULL,                                                                   'Wala pong tubig sa buong blk.', NOW() - INTERVAL '8 days'),
    ...
    (14, 'Bagong Buhay',  'St. Mary St.',   14.8280, 121.0430, 'no_water',         'primewater',    'approved',           true,  false, NULL,                                                                   'Sira ang linya.', NOW() - INTERVAL '14 days'),
    ...
    (17, 'Sapang Palay',  'Phase 4',        14.8310, 121.0460, 'no_water',         'metro_pacific', 'approved',           true,  false, NULL,                                                                   'Wala pong tubig.', NOW() - INTERVAL '2 days'),
    ...
    (22, 'San Martin',    'Phase 1',        14.8360, 121.0510, 'dirty_water',      'primewater',    'approved',           true,  false, NULL,                                                                   'Madumi ang tubig.', NOW() - INTERVAL '7 days'),
    ...
    (28, 'Minuyan',       'Blk 9',          14.8225, 121.0355, 'other',            'metro_pacific', 'approved',           true,  false, NULL,                                                                   'Inconsistent supply.', NOW() - INTERVAL '13 days'),
  ...
  LOOP
    INSERT INTO reports (
      ...
      CASE WHEN rec.status = 'approved' THEN 3 WHEN rec.status = 'resolved' THEN 5 ELSE 0 END
    );
  END LOOP;
END;
$$;
