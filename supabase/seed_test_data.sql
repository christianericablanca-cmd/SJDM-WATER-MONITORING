...
BEGIN
  ...
  FOR rec IN SELECT * FROM (VALUES
    ...
    (16, 'Tumana',        'Sitio Maligaya', 14.8300, 121.0450, 'pipe_infrastructure','primewater',  'submitted',          false, false, NULL,                                                                   'Sumabog ang tubo.', NOW() - INTERVAL '1 day'),
    ...
    (18, 'City Proper',   'St. Rose St.',   14.8320, 121.0470, 'other',            'primewater',    'submitted',          true,  false, NULL,                                                                   'Intermittent supply.', NOW() - INTERVAL '3 days'),
    ...
    (21, 'Buenavista',    'Blk 20',         14.8350, 121.0500, 'water_leak',       'metro_pacific', 'submitted',          true,  false, NULL,                                                                   'Tumutulo ang tubo.', NOW() - INTERVAL '6 days'),
