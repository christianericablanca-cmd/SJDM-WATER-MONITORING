    ...
    <div className="fixed bottom-4 left-4 right-4 z-50 sm:left-auto sm:right-4 sm:w-80 animate-in slide-in-from-bottom-4 duration-300">
      <div className="bg-card border rounded-xl shadow-dropdown p-4 flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold">Install WaterWatch</p>
          <p className="text-xs text-muted-foreground mt-0.5">Get the app for faster access and offline support.</p>
