...
export function BottomNav() {
  ...
  return (
    <>
      ...
      <Link
        href="/report"
        className="md:hidden fixed bottom-20 right-4 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-water text-white shadow-lg active:scale-95 transition-transform"
      >
